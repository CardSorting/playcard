...
var require_index_standalone = __commonJS({
  "node_modules/@firebase/database-compat/dist/index.standalone.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var require$$1$1 = require_crypto();
    ...
    var Base$7 = function(request, url2, options) {
      Emitter.call(this);
    ...
    var instance$b = {
      ...
      _failHandshake: function(error2) {
        ...
        headers2.set("Content-Length", Buffer$8.byteLength(error2.message, "utf8"));
        headers2 = ["HTTP/1.1 400 Bad Request", headers2.toString(), error2.message];
    ...
    var Functor$1 = function(session, method2) {
    ...
    Functor$1.prototype.call = function(error2, message2, callback, context) {
      if (this._stopped) return;
      var record = { error: error2, message: message2, callback, context, done: false }, called = false, self2 = this;
    ...
    Cell$1.prototype.incoming = function(error2, message2, callback, context) {
      this._exec("incoming", error2, message2, callback, context);
    };
    Cell$1.prototype.outgoing = function(error2, message2, callback, context) {
      this._exec("outgoing", error2, message2, callback, context);
    };
    ...
    Cell$1.prototype._exec = function(direction, error2, message2, callback, context) {
      this._functors[direction].call(error2, message2, function(err, msg) {
    ...
    var instance$a = {
      ...
      generateOffer: function() {
        ...
        this._inOrder.forEach(function(ext) {
          ...
          offers.forEach(function(off2) {
            offer.push(Parser.serializeParams(ext.name, off2));
          }, this);
        }, this);
    ...
    var Frame = frame;
    var Message = message;
    var Hybi$2 = function(request, url2, options) {
    ...
    var instance$7 = {
      ...
      frame: function(buffer, type, code) {
        ...
        if (this.MESSAGE_OPCODES.indexOf(message2.opcode) >= 0)
          this._extensions.processOutgoingMessage(message2, function(error2, message3) {
      ...
      _emitMessage: function(message2) {
        ...
        message2.read();
        delete this._message;
        this._extensions.processIncomingMessage(message2, function(error2, message3) {
          if (error2) return this._fail("extension_error", error2.message);
    ...
    var Proxy$1 = function(client2, origin, options) {
    ...
    var Draft75$2 = function(request, url2, options) {
    ...
    var Draft76$1 = function(request, url2, options) {
    ...
    Server$1.http = function(request, options) {
      ...
      var headers2 = request.headers, version = headers2["sec-websocket-version"], key2 = headers2["sec-websocket-key"], key1 = headers2["sec-websocket-key1"], key22 = headers2["sec-websocket-key2"], url2 = this.determineUrl(request);
      if (version || key2)
        return new Hybi(request, url2, options);
      else if (key1 || key22)
        return new Draft76(request, url2, options);
      else
        return new Draft75(request, url2, options);
    };
    var server = Server$1;
    var Base = base;
    ...
    var instance$1 = {
      ...
      _configureStream: function() {
        ...
        this._stream.on("error", function(error2) {
          self2._emitError("Network error: " + self2.url + ": " + error2.message);
          self2._finalizeClose();
        });
      },
      _open: function() {
    ...
    var Client = function(_url, protocols, options) {
      ...
      var proxy2 = options.proxy || {}, endpoint = url.parse(proxy2.origin || this.url), port = endpoint.port || DEFAULT_PORTS[endpoint.protocol], secure = SECURE_PROTOCOLS.indexOf(endpoint.protocol) >= 0, onConnect = function() {
        self2._onConnect();
      }, netOptions = options.net || {}, originTLS = options.tls || {}, socketTLS = proxy2.origin ? proxy2.tls || {} : originTLS, self2 = this;
    ...
    Client.prototype._configureProxy = function(proxy2, originTLS) {
      ...
      this._proxy.on("error", function(error2) {
        self2._driver.emit("error", error2);
      });
    };
    var client = Client;
    ...
    var EventSource = function(request, response, options) {
      ...
      var headers2 = new Headers(), self2 = this;
      if (options.headers) {
    ...
    var Websocket__default = _interopDefaultLegacy$1(Websocket);
    ...
    var PersistentConnection = class _PersistentConnection extends ServerActions {
      ...
      sendGet_(index) {
        ...
        this.sendRequest("g", get2.request, (message2) => {
      ...
      onDataMessage_(message2) {
        if ("r" in message2) {
          this.log_("from server: " + util.stringify(message2));
    ...
    var validateKey = function(fnName, argumentName, key2, optional) {
    ...
    function _initStandalone({ app, url: url2, version, customAuthImpl, customAppCheckImpl, nodeAdmin = false }) {
    ...
    var warn = function(msg) {
      const message2 = "FIREBASE WARNING: " + msg;
    ...
    function initStandalone$1({ app, url: url2, version, customAuthImpl, customAppCheckImpl, namespace, nodeAdmin = false }) {
    ...
    function initStandalone(app, url2, version, nodeAdmin = true) {
...
var require_database2 = __commonJS({
  "node_modules/firebase-admin/lib/database/index.js"(exports) {
    ...
    var error_1 = require_error();
    Object.defineProperty(exports, "FirebaseDatabaseError", { enumerable: true, get: function() {
...
firebase-admin/lib/database/index.js:
   ...
   *)
*/
//# sourceMappingURL=firebase-admin_database.js.map
